...
public final class MyScreencastSession implements ScreencastSession {
    ...
    static final String EXTRA_SCREEN_CAPTURE_INTENT_RESULT_CODE = "EXTRA_SCREEN_CAPTURE_INTENT_RESULT_CODE";
    static final String EXTRA_SCREEN_CAPTURE_INTENT_RESULT_DATA = "EXTRA_SCREEN_CAPTURE_INTENT_RESULT_DATA";
    static final String EXTRA_LIVE_EVENT_TITLE = "EXTRA_LIVE_EVENT_TITLE";
    static final String EXTRA_LIVE_EVENT_SYNOPSIS = "EXTRA_LIVE_EVENT_SYNOPSIS";
    static final String EXTRA_LIVE_VIDEO_QUALITY = "EXTRA_LIVE_VIDEO_QUALITY";
